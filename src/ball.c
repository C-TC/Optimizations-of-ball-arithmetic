...
int main() {
    ...
    lo.mantissa.data.size = 1;
    ro.mantissa.data.size = 2;
    ...
    lo.mantissa.data.bits[0] = 3789676544u;
    lo.mantissa.data.bits[1] = 3789677025u;
    // lo.mantissa.data.bits[2] = 2u;
    ro.mantissa.data.bits[0] = 5u;
    ro.mantissa.data.bits[1] = 1u;
