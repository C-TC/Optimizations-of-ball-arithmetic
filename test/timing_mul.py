...
if __name__ == '__main__':
    data_x, data_y1, data_y2 = load_data('timing_mul.data')

    plt.style.use('seaborn-darkgrid')
    plt.figure(figsize=(12.8, 7.2))
    line_add, = plt.plot(data_x, data_y1, marker='.', color='black', linewidth=1.5, alpha=0.7, label='big_integer_multiply')
    line_precision, = plt.plot(data_x, data_y2, marker='^', color='darkred', linewidth=1.5, alpha=0.7, label='big_integer_multiply_inplace_fixed_precision')
