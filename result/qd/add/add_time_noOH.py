...
if __name__ == '__main__':
    data_x, data_y1, data_y2, data_y3, data_y4, data_y5, data_y6, data_y7, data_y8 = load_data('qd_add_noOH_speed.data')
    ...
    plt.text(512*1.05, 8.5, 'L1 Cache', color='blue', fontsize='x-large')
    plt.axvline(x=4096, linewidth=2, color='blue')
    plt.text(4096*1.05, 8.5, 'L2 Cache', color='blue', fontsize='x-large')
    plt.axvline(x=98304, linewidth=2, color='blue')
    plt.text(98304*1.05, 8.5, 'L3 Cache', color='blue', fontsize='x-large')
    ...
    plt.savefig('qd_add_noOH_speed.pdf')
