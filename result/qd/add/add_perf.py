...
if __name__ == '__main__':
    data_x, data_y1, data_y2, data_y3, data_y4, data_y5, data_y6, data_y7, data_y8 = load_data('qd_add_perf.data')
    ...
    plt.axhline(y=4, linewidth=2, color='darkred')
    plt.text(512*1.05, 3.8, '50% Theoretical Maximum Performance (no FMA)', color='darkred', fontsize='x-large')
